...
<div class="col-xs-12">
    <div class="form-group">
        <a href="{{url('admin/add=lienlac')}}" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-plus"></i>&nbsp;Thêm liên lạc</a><br/><br/>
    </div>
    <table class="table table-bordered table-hover">
        ...
        <tbody> 
            ...
            <tr id="row_{{$lc->id}}">
                ...
                <td><a href="{{url('admin/edit=lienlac/'.$lc->id)}}" class="text-success"><i class="glyphicon glyphicon-edit" title="Sửa"></i></a>&nbsp;
